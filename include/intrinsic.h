...
/*
페이지 디렉토리의 물리적 주소를 PDBR(페이지 디렉토리 기본 레지스터)이라고도 하는 CR3에 저장합니다. 
그러면 새 페이지 테이블이 즉시 활성화됩니다. [IA32-v2a] "MOV--제어 레지스터로/에서 이동" 
및 [IA32-v3a] 3.7.5 "페이지 디렉토리의 기본 주소"를 참조하십시오.
